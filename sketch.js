...
function setup() {
	...
	rope1 = new Rope(bobObject1.body, roof1.body, -bobDiameter * 2, -40);
	rope2 = new Rope(bobObject2.body, roof1.body, -bobDiameter * 2, -20);
	rope3 = new Rope(bobObject3.body, roof1.body, -bobDiameter * 2, 0);
	rope4 = new Rope(bobObject4.body, roof1.body, -bobDiameter * 2, 20);
	rope5 = new Rope(bobObject5.body, roof1.body, -bobDiameter * 2, 40);
